package de.ruedigermoeller.fActoRy.impl;

import de.ruedigermoeller.fActoRy.*;
 ...
 *
 * For more sophisticated applications it might be appropriate to manually set up dispatchers (e.g. new DefaultDispatcher()).
