 ...
 *
 */
public class DependencyResourceLoader {

    public static boolean DevMode = true;
    File resourcePath[];

    public DependencyResourceLoader setResourcePath( String ... path ) {
...
//                            System.out.println("ressolving "+finam+" to "+singleFile.getAbsolutePath());
     ...
     *
     * rules:
     *  if a name is a .js file, lookup ressourcepath ordered
    ...
    public static void main( String arg[]) {
        DependencyResourceLoader loader = new DependencyResourceLoader().setResourcePath(
            ".",
