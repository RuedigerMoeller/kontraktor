 ...
 */
public class _TCPActorPublisher extends ActorServerAdapter {


    public static _TCPActorPublisher Publish(Actor act, int port ) throws Exception {
        return Publish(act,port,null);
    }

    public static _TCPActorPublisher Publish(Actor act, int port, Consumer<Actor> closeListener ) throws Exception {
        _TCPActorPublisher server = new _TCPActorPublisher(act, port);
    ...
    public _TCPActorPublisher(Actor proxy, int port) throws Exception {
        super(proxy);
        this.port = port;
    }
    ...
    protected ActorServerConnection acceptConnections() throws Exception {
        ...
        ActorServerConnection res = new ActorServerConnection(_TCPActorPublisher.this);
