 ...
 * </p>
 *
 * SPECIAL SIZE COUNT IMPLEMENTED!
 *
 * @param <T> the Array entry type
 */
public class MyConcurrentArrayQueue<T> extends AbstractQueue<T>
{
    ...
    private static final int INT_PER_CACHE = 16;
    private static final int HEAD_OFFSET = INT_PER_CACHE - 1;
    private static final int TAIL_OFFSET = INT_PER_CACHE *2 -1;

    private final AtomicReferenceArray<Block<T>> _blocks = new AtomicReferenceArray<>(TAIL_OFFSET + 1);
    private final int _blockSize;
    private final AtomicInteger counter = new AtomicInteger();

    public MyConcurrentArrayQueue()
    {
        this(DEFAULT_BLOCK_SIZE);
    }

    public MyConcurrentArrayQueue(int blockSize)
    {
    ...
    {
        private static final int headOffset = INT_PER_CACHE-1;
        private static final int tailOffset = INT_PER_CACHE*2-1;
