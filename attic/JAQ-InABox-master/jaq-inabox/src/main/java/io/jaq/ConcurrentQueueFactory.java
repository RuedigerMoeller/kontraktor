...
/**
 * The Channel factory produces {@link ConcurrentQueue} instances based on a best fit to the {@link ConcurrentQueueSpec}. This
 * allows minimal dependencies between user code and the Channel implementations and gives users a way to
...
public class ConcurrentQueueFactory {
    ...
    // generic Channel solution to fill gaps for now
