...
public final class SpmcConcurrentQueue<E> extends SpmcConcurrentArrayQueueL3Pad<E> implements Queue<E> {
    ...
    /**
     * This is FFBuffer style offer checking nullity to ensure the next slot is free. The tail counter must still be correctly published so we have
     * to lazy set it. Note that the head counter is not examined.
     */
