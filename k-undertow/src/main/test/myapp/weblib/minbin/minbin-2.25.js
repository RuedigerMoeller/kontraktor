...
// Note: This is one of my first longer javascript programs, so be generous :-). I am open for tips on how to improve,
// especially on how to avoid globals pollution .. (just file an issue)
...
//    };
    ...
    this.obj = function(clazz,object) {
        ...
        if ( object.__typeInfo == clazz || object._actorProxy ) // do not overwrite name of actor proxies
            return object;
