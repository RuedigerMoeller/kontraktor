...
public class DynamicResourceManager extends FileResourceManager {
    ...
    public DynamicResourceManager(boolean devMode, String rootComponent, String ... resourcePath) {
        super(new File("."), 100);
        this.devMode = devMode;
        dependencyResolver = new DependencyResolver(rootComponent,resourcePath);
