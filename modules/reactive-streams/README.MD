...
>**Default Queue and Batch sizings** in Kontraktor are adjusted to network-grade latency, reduce them if building complex in-memory stream processing using Kontraktor.
